...
def test_remove_some(alice, swap, wrapped_coins, pool_token, idx, initial_amounts, n_coins, base_amount):
...
@pytest.mark.itercoins("idx")
def test_remove_one(alice, swap, wrapped_coins, pool_token, idx, initial_amounts, base_amount, n_coins):
    amounts = [0] * n_coins
